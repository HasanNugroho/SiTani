...
<div class="container mt-5 mb-5">
    <div class="row d-flex align-items-center">
        <div class="col-md-6">
            <img
                src="/image/perkebunan/perkebunan.png"
                class="about-img"
                alt=""
            />
        </div>
    ...
    <div class="container">
        ...
        <div class="row mt-4 pb-5">
                ...
                <a href="">
                    <div class="card card-category">
                        <img
                            ...
                            src="/image/perkebunan/kelapa-sawit.png"
                            alt="Cabai"
                        />
            ...
            <div class="col-md-4">
                <a href="">
                    <div class="card card-category">
                        <img
                            class="card-img category-img"
                            src="/image/perkebunan/kelapa.png"
                            alt="Jagung"
                        />
                        <div class="card-img-overlay">
                            <div class="category-content">
            ...
            <div class="col-md-4">
                <a href="">
                    <div class="card card-category">
                        <img
                            class="card-img category-img"
                            src="/image/perkebunan/karet.png"
                            alt="Kacang Tanah"
                        />
                        <div class="card-img-overlay">
                            <div class="category-content">
            ...
            <div class="col-md-4">
                <div class="card card-category">
                    <img
                        class="card-img category-cms"
                        src="/image/perkebunan/coming-soon.png"
                        alt="Coming soon"/>
                    <div class="card-img-overlay">
                        <div class="category-content">
...
<div class="container mt-5 mb-5">
    <div class="feedback-box">
        <div
            class="d-flex justify-content-between align-items-center feedback-content"
        >
            ...
            <button
                type="button"
                class="btn btn-success testi-button"
                data-toggle="modal"
                ...
                <div class="modal-body">
                    <div class="mt-2 mb-2 d-flex justify-content-center">
                        <span
                            class="iconify"
                            data-inline="false"
                            data-icon="bi:chat-square-dots-fill"
                            width="45"
                            height="45"
                            style="color: #219653"
                        ></span>
                    ...
                    <form action="" class="text-center">
                        ...
                        <div class="form-group">
                            ...
                            <textarea
                                ...
                                cols="31"
                                rows="6"
                                placeholder="Web nya sih anjay mabar gaming contolodondon mantappu djiwaa bintang 10 ribu rupiah odading mang oleh"
                            ></textarea>
                        </div>
                        <div class="btn-fd text-center">
                            <button
                                class="btn btn-outline-light feed-button-no"
                                data-dismiss="modal"
                            >
                                CANCEL
                            </button>
                            <button
                                type="submit"
                                class="btn btn-success feed-button"
                            >
                                KIRIM
                            </button>
                        </div>
