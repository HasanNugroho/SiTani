...
<div class="jumbotron">
    <div class="container">
        <h1 class="jumbo-big">Kini, semua bisa
            ...
            bareng <img class="jumbo-big-image" src="/image/icon.svg">
        </h1>
        <p class="jumbo-small">Bareng si tani, kamu bisa mendapatkan kursus menjadi petani cerdas dibimbing mentor-mentor yang berkompeten dibidangnya loh! tunggu apalagi? yuk gabung sekarang!</p>
    ...
    <div class="row d-flex align-items-center">
        ...
        <div class="col-md-6">
            ...
            <p class="about-small">
                ...
                <br> tani, dirancang untuk mudah dipahami dan digunakan di semua elemen masyarakat. Materi yang disampaikan pun dibuat mudah dipahami dan dipandu mentor yang berpengalaman loh!
            </p>
    ...
    <div class="container">
        ...
        <div class="row mt-4 pb-5">
            <div class="col-md-4">
                <a href="">
                    <div class="card card-category">
                        <img class="card-img category-img" src="/image/kategori-pertanian.svg" alt="Kategori Pertanian">
            ...
            <div class="col-md-4">
                <a href="">
                    <div class="card card-category">
                        <img class="card-img category-img" src="/image/kategori-perkebunan.svg" alt="Kategori Pertanian">
                        <div class="card-img-overlay">
                            <div class="category-content">
            ...
            <div class="col-md-4">
                <a href="">
                    <div class="card card-category">
                        <img class="card-img category-img" src="/image/kategori-hidroponik.svg" alt="Kategori Pertanian">
                        <div class="card-img-overlay">
                            <div class="category-content">
...
<div class="container">
    <div class="judul-keuntungan">
        ...
        <p class="deskripsi-keuntungan">Dengan gabung ke kelas gratis di si tani tentu aja ada banyak keuntunganya loh, kira-kira apa saja keuntungnya yuk simak!</p>
    </div>
    <div class="row mb-5 pb-4">
        <div class="col-md-3">
            <img class="img-keuntungan" src="/image/keuntungan1.svg" alt="Gratis">
            <h4 class="keuntungan-big">Tanpa dipungut biaya apapun</h4>
            <p class="keuntungan-small">Kamu nggak perlu mengeluarkan uang satu rupiah pun untuk mengukuti semua kelas yang ada.</p>
        </div>
        <div class="col-md-3">
            <img class="img-keuntungan" src="/image/keuntungan2.svg" alt="Mentor yang handal">
            <h4 class="keuntungan-big">Dibimbing mentor berpengalaman</h4>
            <p class="keuntungan-small">Semua mentor si tani berpengalaman pada bidangnya masing-masing dan memiliki cara mengajar yang menyenangkan.</p>
        </div>
        <div class="col-md-3">
            <img class="img-keuntungan" src="/image/keuntungan3.svg" alt="Materi berkualitas">
            <h4 class="keuntungan-big">Video dan materi yang berkualitas</h4>
            <p class="keuntungan-small">Video pembelajaran yang ada di si tani, semua memiliki resolusi maksimal hingga 1080p! dan materi yang dibuat mudah dipahami.</p>
        </div>
        <div class="col-md-3">
            <img class="img-keuntungan" src="/image/keuntungan4.svg" alt="Ringkasan materi tersedia">
            <h4 class="keuntungan-big">Gratis ringkasan materi yang bisa kamu unduh</h4>
            <p class="keuntungan-small">Setelah menyimak pembelajaran, kamu juga bisa mendapatkan ringkasan materi yang disampaikan untuk kamu pelajari lagi loh..</p>
        </div>
    </div>
</div>
{{-- KEUNTUNGAN END --}}
...
<div class="container mt-5 mb-5">
    <div class="feedback-box">
        <div class="d-flex justify-content-between align-items-center feedback-content">
            ...
            <a href="" class="btn btn-success testi-button">KIRIM PENDAPATMU</a>
        </div>
    </div>
</div>
{{-- FEEDBACK END --}}
